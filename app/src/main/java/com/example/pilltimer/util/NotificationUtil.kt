...
import com.example.pilltimer.AppConstants
import com.example.pilltimer.TimerNotificationActionReceiver
import com.example.pilltimer.R
...
class NotificationUtil {
    companion object {
        ...
        private fun <T> getPendingIntentWithStack(context: Context, javaClass: Class<T>): PendingIntent{
            ...
            stackBuilder.addParentStack(javaClass) // BUG.
